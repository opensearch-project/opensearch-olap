 ...
 *
 * <p>The coordinator receives ExecuteFragmentResponse from each data node.
 * The ResultCollector merges these partial results into a final QueryResult.
 *
 * TODO: Implement with support for:
 * - Merging Arrow IPC streams from multiple nodes
 * - Applying final aggregation on coordinator for PARTIAL → FINAL plans
 * - Applying final ORDER BY / LIMIT on merged results
