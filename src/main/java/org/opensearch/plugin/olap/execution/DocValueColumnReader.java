 ...
 *
 * <p>DocValues are the columnar storage in Lucene, ideal for analytical workloads. Each field type
 * maps to a specific DocValues type:
 *
 * <ul>
 *   <li>long/int/short/byte → NumericDocValues or SortedNumericDocValues
 *   <li>keyword/string → SortedDocValues or SortedSetDocValues
 *   <li>float/double → NumericDocValues (encoded as long bits)
 * </ul>
 */
