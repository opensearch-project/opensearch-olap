 ...
 *
 * <p>Contains the serialized plan fragment (as JSON), the query ID,
 * fragment ID, and the list of shards this task should read from.
 *
 * <p>Modeled after Presto's TaskUpdateRequest which carries the PlanFragment,
 * session properties, and split assignments to worker nodes.
 */
